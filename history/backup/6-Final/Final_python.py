...
def sendtime():
    while True:
        ...
        py_serial.write(hour1.encode('utf-8'))
        time.sleep(0.1)
        py_serial.write(hour2.encode('utf-8'))
        time.sleep(0.1)
        py_serial.write(min1.encode('utf-8'))
        time.sleep(0.1)
        py_serial.write(min2.encode('utf-8'))
        time.sleep(0.1)
...
# //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
       ...
       #한글 리스트
        def charToArduino():
            ...
            if str_list[0] == '3' and errorstate==True:
                if str_list[1] == '2' :
                    if str_list[2] == '1' :
                        hanguel_change = "d"
                        py_serial.write(hanguel_change.encode('utf-8'))
            ...
            if str_list[0] == '2' and errorstate==True:
                if str_list[1] == '6' :
                    if str_list[1] == '1' :
                        hanguel_change = "n"
                        py_serial.write(hanguel_change.encode('utf-8'))
