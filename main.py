...
def framein(camstate,frame,img_counter):
    print(camstate)
    img_name = "src/imgs/opencv_frame_{}.png".format(img_counter)
...
# //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    cv2.imwrite('src/imgs/result.png', img_out)
...
if __name__  == '__main__' :
    ...
    photo_result = tk.PhotoImage(file="src/imgs/wait.png")
    ...
    def redata() :
        ...
        photo_result = tk.PhotoImage(file="src/imgs/result.png")
    ...
    treeview = ttk.Treeview(frame_info, columns=(1,2,3), height=13, show="headings")
    treeview.pack()
    ...
    style = ttk.Style()
    style.configure("Treeview.Heading", font=('맑은 고딕',15,'bold'))
